...
# -------------------------
def load_data(client_file="client7.csv", test_split_ratio=0.5):
...
# -------------------------
def client_fn(cid: str, csv_path="client7.csv"):
    return FlowerADMMClient(client_csv_path=csv_path).to_client()

if __name__ == "__main__":
    # Example CLI usage for a single client process:
    # python admm_flower_client.py client7.csv
    import sys
    from flwr.client import start_client

    client_csv = "client7.csv" if len(sys.argv) < 2 else sys.argv[1]

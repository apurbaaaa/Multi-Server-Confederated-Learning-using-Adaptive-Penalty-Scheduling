...
# -------------------------
def load_data(client_file="client10.csv", test_split_ratio=0.5):
    try:
...
# -------------------------
def client_fn(cid: str, csv_path="client10.csv"):
    return FlowerADMMClient(client_csv_path=csv_path).to_client()

if __name__ == "__main__":
    # Example CLI usage for a single client process:
    # python admm_flower_client.py client10.csv
    import sys
    from flwr.client import start_client

    client_csv = "client10.csv" if len(sys.argv) < 2 else sys.argv[1]
